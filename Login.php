                    ...
                    <div class="row">
                        <div class="col-lg-10 col-xl-7 mx-auto">
                            ...
                            <div class="alert alert-warning alert-dismissible fade show" role="alert">
                                <strong>Login tidak berhasil</strong> <?php echo $_GET['pesan']; ?>
                            ...
                            <form action="cekLogin.php">
                                ...
                                <div class="form-group mb-3">
                                    <input id="inputEmail" type="email" placeholder="Masukkan alamat email" required=""
                                        autofocus="" class="form-control rounded border-0 shadow-sm px-4">
                                </div>

                                <label for="inputPassword" class="mx-3">Password</label>
                                <div class="form-group mb-3">
                                    <input id="inputPassword" type="password" placeholder="Masukkan password"
